...
This project was taken from https://github.com/IBM-Bluemix/get-started-tomcat just for showing Cloud Foundry approach (so first step is needn't do)
...
From within the working directory push your app to Bluemix
```
cf push
```
